...
public class Case13 {
	...
	void test07() throws InterruptedException{
		...
		assertEquals("ITリテラシー① | LMS", webDriver.getTitle());
		assertThat(sectionName.getText(), is(containsString("あなたのスコア：0.0点")));
